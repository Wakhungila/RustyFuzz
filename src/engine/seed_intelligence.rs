...
fn risk_selector_specs() -> Vec<RiskSelectorSpec> {
    [
        ...
        (
            ...
            76,
            "bridge lock path should precede outbound mint/release accounting",
            &["token balance and approval"][..],
            &[SeedTag::Bridge, SeedTag::Erc20][..],
        ),
        (
            "burn(address,uint256)",
            78,
            "bridge burn path should precede outbound release accounting",
        ...
        (
            "sendMessage(bytes)",
            74,
            "bridge send path records message nonce and replay-protection state",
            &["message payload"][..],
            &[SeedTag::Bridge][..],
        ),
        (
            "prove(bytes)",
            82,
            "bridge proof path should gate later finalization",
            &["message proof"][..],
            &[SeedTag::Bridge][..],
        ),
        (
            "relayMessage(bytes)",
            80,
            "bridge relay path exercises message nonce and authorization checks",
            &["message proof or relayer role"][..],
            &[SeedTag::Bridge][..],
        ),
        (
            "finalize(bytes)",
        ...
        (
            ...
            86,
            "bridge finalization should consume a message nonce exactly once",
            &["valid message proof"][..],
            &[SeedTag::Bridge][..],
        ),
        (
            ...
            82,
            "bridge release path should correspond to prior burn or lock accounting",
            &["valid finalized message"][..],
            &[SeedTag::Bridge, SeedTag::Erc20][..],
        ),
    ]
    .into_iter()
